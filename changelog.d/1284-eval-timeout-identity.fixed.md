...
toolchain fields. Cross-host PolicyEngine paths normalize to stable semantic
anchors while import order, relative module origins, and sealed-root layout
remain score-affecting. Git checkout identities must carry exactly the
